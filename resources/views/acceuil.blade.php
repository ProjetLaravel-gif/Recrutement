        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto job-browse">
            <li class="nav-item dropdown">
              <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">parcourir les emploies</a>
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li class="search-by">
                  <h5>par categories</h5>
                  <ul>
        ...
        <div class="row">
          <div class="col-12">
            <div class="banner-content">
              <p>creer un compte gratuit pour trouver des milliers d'emplois emplois et opportunités de carriere autour de vous!</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col">
            <ul class="nav nav-tabs job-tab" id="myTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="recent-tab" data-toggle="tab" href="#recent" role="tab" aria-controls="recent" aria-selected="true">emplois recent</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="feature-tab" data-toggle="tab" href="#feature" role="tab" aria-controls="feature" aria-selected="false">emplois de fonctionalité</a>
              </li>
            </ul>
                  ...
                  <div class="col-lg-6">
                    <div class="job-list half-grid">
                      ...
                      <div class="body">
                        ...
                        <div class="more">
                          <div class="buttons">
                            <a href="#" class="button">appliquer maintenant</a>
