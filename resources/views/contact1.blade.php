    ...
    <div class="row">
      <div class="col-md-6">
        <div class="breadcrumb-area">
          <h1>Contact recruteur</h1>
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active" aria-current="page">Contact recruteur</li>
            </ol>
          </nav>
        </div>
      </div>
       ...
       $('envoyer').click(function(){
              ...
              $.ajax({
                ...
                success: function(successData){
                  ...
                  $('.alert.success').text('successData').slideDown(200);
                },
                ...
                var error = errorData.responseJSON.message;
                  ...
                  for(var i in error){
                    for (var j in error[i]) {
                      ...
                      $('.alert.error').append('<p>'+message+'</p>');
