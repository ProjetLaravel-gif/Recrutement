              ...
              <div class="post-content-wrapper">
                  <div class="basic-info-input">
                    ...
                    <div id="job-title" class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text"  placeholder="votre intitulé içi" name="intitule" class="form-control">
                      </div>
                    </div>
                    ...
                    <div id="dommaine" class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="dommaine" name="dommaine">
                      </div>
                    </div>
                    ...
                    <label class="col-md-3 col-form-label">nombre d'annes d'experiences</label>    
                          <div class="col-md-6">
                            <div class="form-group">
                              <select class="form-control"name="nbr_annee_experiences">
                      ...
                      <div class="col-md-9">
                        <input type="text" class="form-control" placeholder="diplome" name="dimplome">
                      </div>
                    </div>
                   ...
                   <div class="col-md-6">
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="competences" name="competences">
                            </div>
                          </div>
                      </div>
                    ...
                    <div class="col-md-6">
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="renumeration" name="renumeration">
                            </div>
                          </div>
                           </div>
                        ...
                        <div id="dateprevu" class="form-group row">
                          ...
                          <div class="col-md-6">
                            <div class="form-group datepicker">
                              <input type="date" class="form-control" placeholder="date de debut prevue" name="date_debut_prevu">
                            </div>
                          </div>
                      </div>
...
function initMap() {
  ...
  var uluru = {lat:35.7300362 , lng: -0.5852167};   // chaque  endroi 3andah  had les 2 valur tjibhoum m google ida t7ab  tbedel 
 //- ah ok saha
 // madirhach view offre ?   hadi edit offre si mais nssit majiha lol att nhawess ok 
                    ...
                    <div id="about-company" class="row">
                      ...
                      <div class="col-md-9">
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              <input type="text" class="form-control" placeholder="Web Address" name="webaddresse">
                            </div>
                          </div>
                          <div class="col-md-12">
                            <div class="form-group">
                              <textarea class="form-control" placeholder="petite description" name="description"></textarea>
                            </div>
                          </div>
                        </div>
                      </div>
