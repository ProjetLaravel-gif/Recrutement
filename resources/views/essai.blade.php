...
$sth->execute(array(':year' => 2019, ':recruteur_id' => 1));


$stat1="select month(dates) as mois,count(id) as nb from offres o recruteurs r where  year(dates) = :year and o.recruteur_id = r.id GROUP BY mois ORDER BY mois ASC"; 
